...
const Button = ({ icon, text }: ButtonType) => {
  return (
    <button
      type='button'
      className='gap-2 text-white bg-blue-500 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm pl-1 pr-2 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-blue-100 '
    >
      <Svg icon={icon} />
      {text}
    </button>
